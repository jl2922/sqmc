module tools
  ...
  save
  private
  public ::  n_choose_k, random_int,count_bits_naive,count_bits_imp1, &!subroutines
...
subroutine print_excitation_levels_and_wts(n_det,dets_up,dets_dn,lowest_eigenvector,norb,orbital_symmetries)
!=====================================================================================================================
