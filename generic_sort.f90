module generic_sort
  ...
  interface sort
     ...
     module procedure shell_sort_int, shell_sort_simple_int, shell_sort_int_int, shell_sort_ik_vec, shell_sort_real_rank2, shell_sort_real_rank1_int_rank1_int_rank1,shell_sort_real_rank1_ik_vec_rank1_ik_vec_rank1
#else
  ...
  interface sort_by_first_argument
    module procedure sort_by_first_argument_int_int, sort_by_first_argument_ik, sort_by_first_argument_int_rk
